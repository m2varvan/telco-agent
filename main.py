...
4. AMBIGUOUS / NORMAL VARIATION: If KPIs are normal (status: ok), no CM changes, and no active alarms, set root_cause: "UNDETERMINED - Normal variation / Not a real incident" and set further_investigation_required: true.
